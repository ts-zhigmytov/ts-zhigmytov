...
- 🤔 С удовольствием пообщаюсь на тему ML, Python, SQL, CS, DS, математики, образования, ИИ
- ⚡ Могу отредактировать текст, сделать несложную модель, разработать стратегию
